...
typedef struct AVD3D11VADeviceContext {
    ...
    /**
     * If unset, this will be set from the device field on initSW.
     *
     * Deallocating the AVHWDeviceContext will always release this interface,
     * and it does not matter whether it was user-allocated.
     */
    ...
    /**
     * If unset, this will be set from the device_context field on initSW.
     *
     * Deallocating the AVHWDeviceContext will always release this interface,
     * and it does not matter whether it was user-allocated.
     */
     ...
     *
     * If unset on initSW, the hwcontext implementation will set them to use an
     * internal mutex.
     *
...
typedef struct AVD3D11VAFramesContext {
     ...
     * on initSW, the hwframes implementation will allocate and set an array
